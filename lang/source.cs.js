...
const grammar = {
  ...
  repository: {
    ...
    'generic-constraints': {
      ...
      patterns: [
        {name: 'storage.type.class.cs', match: '\\bclass\\b'},
        {name: 'storage.type.struct.cs', match: '\\bstruct\\b'},
        {name: 'keyword.other.constraint.default.cs', match: '\\bdefault\\b'},
        {name: 'keyword.other.constraint.notnull.cs', match: '\\bnotnull\\b'},
        {
    ...
    'goto-statement': {
      ...
      patterns: [
        ...
        {name: 'entity.name.label.cs', match: '@?[_[:alpha:]][_[:alnum:]]*'}
      ]
    },
    'return-statement': {
      begin: '(?<!\\.)\\b(return)\\b',
    ...
    'assignment-operators': {
      patterns: [
        ...
        {name: 'keyword.operator.assignment.cs', match: '\\='}
      ]
    },
    'expression-operators': {
      patterns: [
        {name: 'keyword.operator.bitwise.shift.cs', match: '<<|>>>?'},
        {name: 'keyword.operator.comparison.cs', match: '==|!='},
        {name: 'keyword.operator.relational.cs', match: '<=|>=|<|>'},
        {name: 'keyword.operator.logical.cs', match: '\\!|&&|\\|\\|'},
        {name: 'keyword.operator.bitwise.cs', match: '\\&|~|\\^|\\|'},
        {name: 'keyword.operator.decrement.cs', match: '--'},
        {name: 'keyword.operator.increment.cs', match: '\\+\\+'},
        {name: 'keyword.operator.arithmetic.cs', match: '\\+|-(?!>)|\\*|/|%'},
        {name: 'keyword.operator.null-coalescing.cs', match: '\\?\\?'},
        {name: 'keyword.operator.range.cs', match: '\\.\\.'}
      ]
    },
    'with-expression': {
      begin: '(?<!\\.)\\b(with)\\b\\s*(?=\\{|//|/\\*|$)',
    ...
    'conditional-operator': {
      patterns: [
        ...
        {name: 'keyword.operator.conditional.colon.cs', match: ':'}
      ]
    },
    'await-expression': {
    ...
    'language-variable': {
      patterns: [
        {name: 'variable.language.$1.cs', match: '\\b(base|this)\\b'},
        {name: 'variable.other.$1.cs', match: '\\b(value)\\b'}
      ]
    },
    ...
    argument: {
      patterns: [
        {name: 'storage.modifier.$1.cs', match: '\\b(ref|in)\\b'},
        {
          begin: '\\b(out)\\b',
    ...
    'ref-modifier': {name: 'storage.modifier.ref.cs', match: '\\bref\\b'},
    'readonly-modifier': {
    ...
    'type-name': {
      patterns: [
        ...
        {name: 'entity.name.type.cs', match: '@?[_[:alpha:]][_[:alnum:]]*'}
      ]
    },
    'type-arguments': {
      begin: '<',
    ...
    'punctuation-comma': {name: 'punctuation.separator.comma.cs', match: ','},
    'punctuation-semicolon': {
      name: 'punctuation.terminator.statement.cs',
      match: ';'
    },
    'punctuation-accessor': {name: 'punctuation.accessor.cs', match: '\\.'},
    ...
    'preprocessor-load': {
      ...
      patterns: [
        {match: '\\"[^"]*\\"', captures: {0: {name: 'string.quoted.double.cs'}}}
      ]
    },
    'preprocessor-r': {
      begin: '\\b(r)\\b',
    ...
    'preprocessor-line': {
      ...
      patterns: [
        ...
        {match: '[0-9]+', captures: {0: {name: 'constant.numeric.decimal.cs'}}},
        {match: '\\"[^"]*\\"', captures: {0: {name: 'string.quoted.double.cs'}}}
      ]
    },
    ...
    'xml-character-entity': {
      patterns: [
        ...
        {name: 'invalid.illegal.bad-ampersand.cs', match: '&'}
      ]
    },
    'xml-comment': {
      name: 'comment.block.cs',
