 ...
 * uses.
 * @param {Record<string,string> | {} | null | undefined} scopeToClassExtension
 */
export const createTheme = (scopeToClassExtension) => {
  scopeToClassExtension = scopeToClassExtension ?? {};
  const scopeToClass = {
    ...scopeToClassGithub,
    ...scopeToClassExtension
  }
  return {
    name: 'custom',
    settings: [
      ...
      // Add scopes.
      ...Object.keys(scopeToClass).map(function (scope) {
        const className = scopeToClass[scope]
        /** @type {string} */
        let field
        /** @type {string} */
        let value
